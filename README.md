...
ungrund oracle reads state changes on chain and respond to data requests when asked scanning the chain with blocker explorers.
...
## .env
```
TZ_SK=<TEZOS SECRET KEY>
TZ_ENDPOINT=<TEZOS NODE PUBLIC ENDPOINT>
KT_ORACLE=<UNGRUND ORACLE CONTRACT>
```
